"""
Django settings for studentskiparlament project.
...
ROOT_URLCONF = 'studentskiparlament.urls'
...
WSGI_APPLICATION = 'studentskiparlament.wsgi.application'
